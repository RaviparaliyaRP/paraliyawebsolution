      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20 gap-4">
          ...
          <Link href="/" className="flex items-center gap-3 group flex-shrink-0">
            <div className="relative w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 flex-shrink-0 flex items-center">
              <Image
            ...
            <div className="flex items-center gap-8">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="text-sm xl:text-base text-gray-700 hover:text-accent-purple font-medium transition-colors duration-200 relative group focus:outline-none whitespace-nowrap flex items-center"
                >
                  {item.name}
                  <span className="absolute -bottom-1 left-0 right-0 h-0.5 bg-accent-purple scale-x-0 transition-transform duration-300 group-hover:scale-x-100 origin-center"></span>
                </Link>
              ))}
            </div>
          </nav>

          {/* Desktop CTA Section - Vertically Centered */}
          <div className="hidden lg:flex items-center gap-3 flex-shrink-0 min-w-0">
            <a
              href="tel:+919898463251"
              className="hidden xl:flex items-center gap-2 text-gray-700 hover:text-accent-purple transition-colors duration-200 focus:outline-none flex-shrink-0"
            >
            ...
            <Link
              href="/contact"
              className="bg-gradient-to-r from-accent-purple to-accent-blue text-white px-5 xl:px-6 py-2.5 rounded-lg font-semibold text-sm xl:text-base hover:shadow-brand-lg transition-all duration-300 transform hover:scale-105 focus:outline-none whitespace-nowrap flex-shrink-0 flex items-center justify-center"
            >
          ...
          >
            <div className="px-4 py-6">
              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                <a
                  href="tel:+919898463251"
                  className="flex items-center justify-center gap-2 text-gray-700 hover:text-accent-purple transition-colors duration-200 py-3 px-3 rounded-lg hover:bg-gray-50 focus:outline-none"
                >
                  <Phone className="w-4 h-4 flex-shrink-0" />
